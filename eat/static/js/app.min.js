$(function() {
	...
	var i = 0,
		...
		m = [
			["早饭",
				"面包 蛋糕 荷包蛋 烧饼 饽饽 肉夹馍 油条 馄饨 火腿 面条 小笼包 玉米粥 肉包 煎饼果子 饺子 煎蛋 烧卖 生煎 锅贴 包子 酸奶 苹果 梨 香蕉 皮蛋瘦肉粥 蛋挞 南瓜粥 煎饼 玉米糊 泡面 粥 馒头 燕麦片 水煮蛋（拌酱油版） 米粉 豆浆 牛奶 花卷 豆腐脑 煎饼果子 小米粥 黑米糕 鸡蛋饼 牛奶布丁 水果沙拉 鸡蛋羹 南瓜馅饼 鸡蛋灌饼 奶香小馒头 汉堡包 披萨 八宝粥 三明治 蛋包饭 豆沙红薯饼 驴肉火烧 粥粥 粢饭糕 蒸饺"
				.split(" ")
			],
			["午饭",
	...
	m[1][1] = m[2][1], a.on("animationend webkitAnimationEnd", function(t) {
		...
		if (g.toggleClass("playing", !i), i) i = 0, "monster" == w && x.text(u[t(u.length)]), c.text("！"), l.find("span")
			.text("换一个"), clearTimeout(b), document.title = a.text() + "今天中午吃什么？";
		else {
			i = 1, k++, 2 == k && e("我就知道你会换一个"), 5 == k && e("别换了哥，就这个吧"), 10 == k && e(
				"还换？？？"), 20 == k && e("再换我可要报警了！"), 30 == k && e("别吃了您");
